...
export default async function EmployerCandidatePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <main className="mx-auto w-full max-w-6xl space-y-6 p-4 lg:p-8">
      ...
      <section className="rounded-2xl border bg-card p-6">
        <div className="flex flex-col gap-6 sm:flex-row sm:items-start">
          ...
          <div className="min-w-0 flex-1">
            ...
            {profile ? (
              <>
                <p className="mt-1 text-muted-foreground">{profile.currentRole ?? profile.headline}</p>
              ...
              <div className="mt-3">
                <p className="text-sm text-muted-foreground">
                  No job seeker profile has been completed for this candidate yet.
                </p>
        ...
        {profile?.bio && (
          <div className="mt-6 border-t pt-6">
            ...
            <p className="mt-2 whitespace-pre-wrap text-sm leading-6 text-muted-foreground">{profile.bio}</p>
          </div>
        )}
      ...
      <section className="rounded-2xl border bg-card">
        ...
        {applications.length === 0 ? (
          <div className="p-6 text-sm text-muted-foreground">
            This candidate has no applications to your company.
          </div>
        ) : (
      ...
      {/* Portfolio */}
      {profile && profile.portfolioProjects.length > 0 && (
        <section className="rounded-2xl border bg-card p-6">
