  ...
  if (!user) {
    return (
      <Link
        ...
        <User2Icon className="relative size-4 shrink-0 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110" />

        <span className="relative hidden whitespace-nowrap sm:inline-block">Join JobMan</span>

        <ArrowRight className="relative hidden size-4 shrink-0 transition-transform duration-300 group-hover:translate-x-1 sm:inline-block" />
      </Link>
    );
  }
